...
class PoliticaPage: UIViewController {
    ...
    //MARK: - Método para Observar quando entrar e sair de Background o App
        ...
        super.viewDidLoad()
        title = "política de privacidade".uppercased()
    ...
    // MARK: - Inserindo WebView termo
        ...
        let request = URLRequest(url: URL(string: "https://www.picpay.com/app_webviews/privacy/")!)
